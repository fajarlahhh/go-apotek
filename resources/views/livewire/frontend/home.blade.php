              ...
              <div class="col-sm-12 align-self-center">
                <div class="ec-slide-content slider-animation">
                  ...
                  <div class="ec-slide-desc">
                    ...
                    <a href="#" class="btn btn-lg btn-primary">Shop Now <i class="ecicon eci-angle-double-right"
    ...
    <div class="container">
      ...
      <div class="row margin-minus-b-15 margin-minus-t-15">
        <div class="ec_cat_content ec_cat_content_1 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/6.jpg" alt="" />
            </div>
        ...
        <div class="ec_cat_content ec_cat_content_2 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/7.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Furniture</h3>
              <ul>
        ...
        <div class="ec_cat_content ec_cat_content_3 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/8.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Clothing</h3>
              <ul>
        ...
        <div class="ec_cat_content ec_cat_content_4 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/9.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Beauty</h3>
              <ul>
        ...
        <div class="ec_cat_content ec_cat_content_5 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/10.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Watches</h3>
              <ul>
        ...
        <div class="ec_cat_content ec_cat_content_6 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/11.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Jewellery</h3>
              <ul>
        ...
        <div class="ec_cat_content ec_cat_content_7 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/12.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Fashion</h3>
              <ul>
        ...
        <div class="ec_cat_content ec_cat_content_8 col-sm-12 col-md-6 col-lg-3">
          <div class="ec_cat_inner">
            <div class="ec-category-image">
              <img src="assets/images/category-image/13.jpg" alt="" />
            </div>
            <div class="ec-category-desc">
              <h3>Electronic</h3>
              <ul>
        ...
        <div class="col-md-12 ec-pro-tab">
          <ul class="ec-pro-tab-nav nav justify-content-end">
            ...
            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                href="#tab-pro-special-offer">Top
                Rated Products</a></li>
            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                    ...
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/29_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/29_4.jpg" alt="Product" />
                        </a>
                        <span class="flags">
                        ...
                        <div class="ec-pro-actions">
                          <a class="ec-btn-group wishlist" title="Wishlist"><img
                              src="assets/images/icons/pro_wishlist.svg" class="svg_img pro_svg" alt="" /></a>
                            ...
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/29_1.jpg"
                                    data-src-hover="assets/images/product-image/29_1.jpg" data-tooltip="Gray"><span
                                      style="background-color:#a88960;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/29_2.jpg"
                                    data-src-hover="assets/images/product-image/29_2.jpg" data-tooltip="Orange"><span
                                      style="background-color:#f778fc;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/29_3.jpg"
                                    data-src-hover="assets/images/product-image/29_3.jpg" data-tooltip="Green"><span
                                      style="background-color:#8b83ff;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/29_4.jpg"
                                    data-src-hover="assets/images/product-image/29_4.jpg" data-tooltip="Sky Blue"><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/30_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/30_3.jpg" alt="Product" />
                        </a>
                        <span class="flags">
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/30_1.jpg"
                                    data-src-hover="assets/images/product-image/30_1.jpg" data-tooltip="Gray"><span
                                      style="background-color:#e9e9e9;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/30_2.jpg"
                                    data-src-hover="assets/images/product-image/30_2.jpg" data-tooltip="Orange"><span
                                      style="background-color:#b6f0ff;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/30_3.jpg"
                                    data-src-hover="assets/images/product-image/30_3.jpg" data-tooltip="Green"><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/31_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/31_2.jpg" alt="Product" />
                        </a>
                        <div class="ec-pro-actions">
                          <a class="ec-btn-group wishlist" title="Wishlist"><img
                              src="assets/images/icons/pro_wishlist.svg" class="svg_img pro_svg" alt="" /></a>
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/31_1.jpg"
                                    data-src-hover="assets/images/product-image/31_1.jpg" data-tooltip="Gray"><span
                                      style="background-color:#d8bd74;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/31_2.jpg"
                                    data-src-hover="assets/images/product-image/31_2.jpg" data-tooltip="Orange"><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/32_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/32_1.jpg" alt="Product" />
                        </a>
                        <span class="flags">
                          <span class="sale">Sale</span>
                        </span>
                    ...
                    <div class="ec-pro-content">
                      ...
                      <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Long slive t-shirt for men</a>
                      </h5>
                      <div class="ec-pro-rat-price">
                        <span class="ec-price">
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/32_1.jpg"
                                    data-src-hover="assets/images/product-image/32_0.jpg" data-tooltip="Gray"><span
                                      style="background-color:#ac96fd;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/32_2.jpg"
                                    data-src-hover="assets/images/product-image/32_2.jpg" data-tooltip="Orange"><span
                            ...
                            <div class="ec-pro-size">
                              <ul class="ec-opt-size">
                                <li class="active"><a href="#" class="ec-opt-sz" data-old="$410.00"
                                    data-new="$399.00" data-tooltip="Small">S</a></li>
                                <li><a href="#" class="ec-opt-sz" data-old="$425.00" data-new="$499.00"
                                    data-tooltip="Medium">M</a>
                                </li>
                                <li><a href="#" class="ec-opt-sz" data-old="$450.00" data-new="$550.00"
                                    data-tooltip="Large">L</a>
                                </li>
                                <li><a href="#" class="ec-opt-sz" data-old="$599.00" data-new="$489.00"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/33_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/33_3.jpg" alt="Product" />
                        </a>
                        <span class="flags">
                          <span class="sale">Sale</span>
                        </span>
                    ...
                    <div class="ec-pro-content">
                      ...
                      <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Apple SE Smartwatch (GPS,
                          40mm)</a></h5>
                      <div class="ec-pro-rat-price">
                        <span class="ec-price">
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/33_1.jpg"
                                    data-src-hover="assets/images/product-image/33_1.jpg" data-tooltip="Gray"><span
                                      style="background-color:#cecece;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/33_2.jpg"
                                    data-src-hover="assets/images/product-image/33_2.jpg" data-tooltip="Orange"><span
                                      style="background-color:#fcb0b0;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/33_3.jpg"
                                    data-src-hover="assets/images/product-image/33_3.jpg" data-tooltip="Green"><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/34_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/34_2.jpg" alt="Product" />
                        </a>
                        <span class="flags">
                          <span class="new">New</span>
                        </span>
                    ...
                    <div class="ec-pro-content">
                      ...
                      <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Portable Room Air Purifier</a>
                      </h5>
                      <div class="ec-pro-rat-price">
                        <span class="ec-price">
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/34_1.jpg"
                                    data-src-hover="assets/images/product-image/34_1.jpg" data-tooltip="Gray"><span
                                      style="background-color:#e2e2e2;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/34_3.jpg"
                                    data-src-hover="assets/images/product-image/34_3.jpg" data-tooltip="Orange"><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/35_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/35_3.jpg" alt="Product" />
                        </a>
                        <div class="ec-pro-actions">
                          <a class="ec-btn-group wishlist" title="Wishlist"><img
                              src="assets/images/icons/pro_wishlist.svg" class="svg_img pro_svg" alt="" /></a>
                    ...
                    <div class="ec-pro-content">
                      ...
                      <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Hooded Neck full slive T-Shirt</a>
                      </h5>
                      <div class="ec-pro-rat-price">
                        <span class="ec-price">
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-color">
                              <ul class="ec-opt-swatch ec-change-img">
                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                    data-src="assets/images/product-image/35_1.jpg"
                                    data-src-hover="assets/images/product-image/35_1.jpg" data-tooltip="Gray"><span
                                      style="background-color:#fd9191;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/35_2.jpg"
                                    data-src-hover="assets/images/product-image/35_2.jpg" data-tooltip="Orange"><span
                                      style="background-color:#8991ff;"></span></a>
                                </li>
                                <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/35_3.jpg"
                                    data-src-hover="assets/images/product-image/35_3.jpg" data-tooltip="Green"><span
                            ...
                            <div class="ec-pro-size">
                              <ul class="ec-opt-size">
                                <li class="active"><a href="#" class="ec-opt-sz" data-old="$65.00"
                                    data-new="$49.00" data-tooltip="Small">S</a></li>
                                <li><a href="#" class="ec-opt-sz" data-old="$70.00" data-new="$55.00"
                                    data-tooltip="Medium">M</a>
                                </li>
                                <li><a href="#" class="ec-opt-sz" data-old="$79.00" data-new="$60.00"
                                    data-tooltip="Large">L</a>
                                </li>
                                <li><a href="#" class="ec-opt-sz" data-old="$82.00" data-new="$63.00"
                                    data-tooltip="Extra Large">XL</a></li>
                              </ul>
                            </div>
                          </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                  <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                      <div class="ec-pro-image">
                        <a href="product-left-sidebar.html" class="image">
                          <img class="main-image" src="assets/images/product-image/36_1.jpg" alt="Product" />
                          <img class="hover-image" src="assets/images/product-image/36_2.jpg" alt="Product" />
                        </a>
                        <div class="ec-pro-actions">
                          <a class="ec-btn-group wishlist" title="Wishlist"><img
                              src="assets/images/icons/pro_wishlist.svg" class="svg_img pro_svg" alt="" /></a>
                      ...
                      <div class="ec-pro-btn">
                        ...
                        <div class="ec-pro-option">
                          <div class="ec-pro-opt-inner">
                            <div class="ec-pro-size">
                              <ul class="ec-opt-size">
                                <li class="active"><a href="#" class="ec-opt-sz" data-old="$200.00"
                                    data-new="$199.00" data-tooltip="Small">Orange</a></li>
                                <li><a href="#" class="ec-opt-sz" data-old="$210.00" data-new="$209.00"
      ...
      <div class="row">
        <div class="ec-banner-inner">
          <div class="ec-banner-block ec-banner-block-1">
            <div class="banner-block">
              ...
              <div class="banner-content">
                ...
                <span class="ec-banner-btn"><a href="#">Shop Now <i class="ecicon eci-angle-double-right"
          ...
          <div class="ec-banner-block ec-banner-block-2">
            <div class="banner-block">
              <img src="assets/images/banner/20.jpg" alt="" />
              <div class="banner-content">
                <div class="banner-text">
          ...
          <div class="ec-banner-block ec-banner-block-3">
            <div class="banner-block">
              <img src="assets/images/banner/21.jpg" alt="" />
              <div class="banner-content">
                <div class="banner-text">
            ...
            <div class="ec-spe-product">
              <div class="ec-spe-pro-inner">
                  ...
                  <div class="ec-spe-pro-image">
                    <div class="ec-spe-pro-cover">
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/8.jpg" alt="">
                      </div>
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/9.jpg" alt="">
                      </div>
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/10.jpg" alt="">
                      </div>
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/11.jpg" alt="">
                      </div>
                    </div>
                ...
                <div class="ec-spe-pro-content col-md-6 col-sm-12">
                  ...
                  <h5 class="ec-spe-pro-title"><a href="product-left-sidebar.html">Solo Wireless smart Headphones</a>
                  </h5>
              ...
              <div class="ec-spe-pro-inner">
                <div class="ec-spe-pro-image-outer col-md-6 col-sm-12">
                  <div class="ec-spe-pro-image">
                    <div class="ec-spe-pro-cover">
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/12.jpg" alt="">
                      </div>
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/13.jpg" alt="">
                      </div>
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/14.jpg" alt="">
                      </div>
                      <div class="ec-spe-pro-slide">
                        <img class="img-responsive" src="assets/images/product-image/15.jpg" alt="">
                      </div>
                    </div>
                    <div class="ec-spe-pro-thumb">
                      <div class="ec-spe-pro-slide">
                ...
                <div class="ec-spe-pro-content col-md-6 col-sm-12">
                  ...
                  <h5 class="ec-spe-pro-title"><a href="product-left-sidebar.html">Royal fragrance Perfume 50ml</a>
                  </h5>
                  <div class="ec-spe-pro-desc">Lorem ipsum dolor sit amet consectetur Lorem ipsum
                    dolor dolor sit amet consectetur Lorem ipsum dolor</div>
                  <div class="ec-spe-price">
                ...
                <div class="ec-test-inner">
                  ...
                  <div class="ec-test-content">
                    ...
                    <div class="ec-test-divider">
                      <img src="assets/images/testimonial/quotes.svg" class="svg_img test_svg" alt="" />
                    </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                <div class="ec-product-inner">
                  <div class="ec-pro-image-outer">
                    <div class="ec-pro-image">
                      <a href="product-left-sidebar.html" class="image">
                        <img class="main-image" src="assets/images/product-image/37_1.jpg" alt="Product" />
                        <img class="hover-image" src="assets/images/product-image/37_2.jpg" alt="Product" />
                      </a>
                      <span class="flags">
                        <span class="new">New</span>
                      </span>
                  ...
                  <div class="ec-pro-content">
                    ...
                    <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Lime Crime Velvetines Liquid Matte
                        Lipstick</a></h5>
                    <div class="ec-pro-rat-price">
                      <span class="ec-price">
                    ...
                    <div class="ec-pro-btn">
                      ...
                      <div class="ec-pro-option">
                        <div class="ec-pro-opt-inner">
                          <div class="ec-pro-size">
                            <ul class="ec-opt-size">
                              <li class="active"><a href="#" class="ec-opt-sz" data-old="$60.00"
                                  data-new="$50.00" data-tooltip="Small">Pink</a></li>
                              <li><a href="#" class="ec-opt-sz" data-old="$70.00" data-new="$65.00"
                                  data-tooltip="Medium">Brown</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="ec-pro-opt-inner">
                          ...
                          <div class="ec-pro-size">
                            <ul class="ec-opt-size">
                              ...
                              <li><a href="#" class="ec-opt-sz" data-old="$82.00" data-new="$60.00"
                                  data-tooltip="Large">L</a></li>
                              <li><a href="#" class="ec-opt-sz" data-old="$85.00" data-new="$70.00"
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ec-product-content m-auto">
                <div class="ec-product-inner">
                  <div class="ec-pro-image-outer">
                    <div class="ec-pro-image">
                      <a href="product-left-sidebar.html" class="image">
                        <img class="main-image" src="assets/images/product-image/38_1.jpg" alt="Product" />
                        <img class="hover-image" src="assets/images/product-image/38_2.jpg" alt="Product" />
                      </a>
                      <span class="flags">
                        <span class="sale">Sale</span>
                      </span>
                  ...
                  <div class="ec-pro-content">
                    ...
                    <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Bathroom and Wash Basin Hand
                        Wash</a></h5>
                    <div class="ec-pro-rat-price">
                      <span class="ec-price">
                        <span class="new-price">$199.00</span>
                      ...
                      <div class="ec-pro-option">
                        <div class="ec-pro-opt-inner">
                          <div class="ec-pro-size">
                            <ul class="ec-opt-size">
                              <li class="active"><a href="#" class="ec-opt-sz" data-old="$200.00"
                                  data-new="$199.00" data-tooltip="Small">Gray</a></li>
                              <li><a href="#" class="ec-opt-sz" data-old="$210.00" data-new="$209.00"
                                  data-tooltip="Medium">Purple</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
